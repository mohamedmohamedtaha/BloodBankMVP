...
public class Data2NotificationsList {
    ...
    @Expose
    private PivotNotificationsList pivot;
    ...
    public PivotNotificationsList getPivot() {
        return pivot;
    }

    public void setPivot(PivotNotificationsList pivot) {
        this.pivot = pivot;
    }
