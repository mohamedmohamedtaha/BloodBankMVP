...
public class ClientGetProfile {
    ...
    @SerializedName("city")
    @Expose
    private CityGetProfile city;
    @SerializedName("blood_type")
    @Expose
    private BloodTypeGetProfile bloodType;
    ...
    public CityGetProfile getCity() {
        return city;
    }

    public void setCity(CityGetProfile city) {
        this.city = city;
    }

    public BloodTypeGetProfile getBloodType() {
        return bloodType;
    }

    public void setBloodType(BloodTypeGetProfile bloodType) {
