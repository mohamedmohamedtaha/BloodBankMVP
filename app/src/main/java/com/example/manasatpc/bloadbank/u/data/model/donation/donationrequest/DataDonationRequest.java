...
package com.example.manasatpc.bloadbank.u.data.model.donation.donationrequest;
...
public class DataDonationRequest {
    ...
    @Expose
    private BloodTypeDonationRequest bloodType;
    ...
    public void setCity(CityDonationRequest city) {
        this.city = city;
    }
    ...
    public void setClient(ClientDonationRequest client) {
        this.client = client;
    }

    public BloodTypeDonationRequest getBloodType() {
        return bloodType;
    }

    public void setBloodType(BloodTypeDonationRequest bloodType) {
